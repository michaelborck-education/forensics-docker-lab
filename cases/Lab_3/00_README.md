# Module 07 — Forensic Lab 3: Autopsy GUI (via noVNC)
...
## What to submit
- `cases/Lab3/autopsy_case/` directory (exported case data).  
- `cases/Lab3/autopsy_report.md` (template provided).
...
- Base directory: `/cases/Lab3/autopsy_case`  
...
Export HTML or PDF into `/cases/Lab3/autopsy_case/export/`.
